$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/resources/features/LoginProfile.feature");
formatter.feature({
...
formatter.step({
  "name": "User login in to application with username \u003cUsername\u003e and password \u003cPassword\u003e",
  "keyword": "When "
});
formatter.step({
  "name": "Home page is populated",
...
formatter.uri("file:src/test/resources/features/LoginProfileCopy2ToUderstHooks.feature");
formatter.feature({
  "name": "Application Login",
  "description": "",
  "keyword": "Feature",
